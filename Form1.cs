...
namespace Lagunovski_Triangle
{
    public partial class Form1 : Form
    {
        ...
        private void Run_button_Click(object sender, EventArgs e)//Главная большая кнопка, и в ней расписаны дальнейшие действия(указания)
        {
            ...
            listView1.Items.Add("Сторона a");//Начало - Что будет написано в listView1
            ...
            listView1.Items.Add("Спецификатор");//Конец - Что будет написано в listView1
            listView1.Items[0].SubItems.Add(triangle.outputA());//Начало - - Что будет показываться в listView1
        ...
        }   //Конец - Что будет показываться в listView1
